	...
	<div id="fullpage">
								...
								<!-- <caption>명년도 수입 예산 예측</caption> -->
									<thead>
										<tr>
											...
											<th colspan="2">내년도 예상 수입액 <br> ${result != null ? result : '0'} 달러</th>
									...
									<tbody>
										...
										<tr>
											<td colspan="2" style="text-align: center;"><input
												type="submit" value="계산하기"> <input type="reset"
												value="초기화"></td>
										</tr>
									</tbody>
								</table>
						...
						<div class="text-container">
							<div class="section1text">
								<div class="textConTop">
									<hr
										style="background: black; height: 2px; border: 0; margin-bottom: 5px;">
									<span
								...
								<p
									style="width: 50%; font-size: 20px; font-weight: 200; margin-top: 80px;">
				...
				<div id="sec2backgroundbox">
					<div class="model-introduce">
						...
						<div class="sec2leftImages">
							<div class="equation">
								<!-- 첫 번째 수식 -->
								<p style="border: 1px solid; width: 480px;">
						...
						<div class="sec2text" style="margin-left: 3%;">
							<hr id="sec2Line">
							<span
								style="font-size: 72px; font-weight: 600; line-height: 1.2; display: inline-block;">02</span><br>
							<span
								style="font-size: 24px; font-weight: 600; margin-top: 10px; display: inline-block;">모델
								소개</span>
							<p
								style="width: 66%; font-size: 20px; font-weight: 200; margin-left: 0;">
								1. 모델 변화(스텝와이즈 기법, StepAIC함수 사용) 진행과정 / 3. 왜 특정 자원은 빼도 되는지에 대한
								근거. 처음에 모델을 생성할 때 4가지 자원의 국제시세를 사용하였지만, 우라늄과 석탄 시세의 경우 AIC수치와
								p값을 기반으로 국내 수입예산의 변화에 미치는 영향이 미미하여 예측 모델에서 제거되었습니다. AIC수치란, 모델의
								적합도를 판단하는 수치이며, p값은 자원 국제시세가 예측 모델을 생성하는데에 통계적으로 유의미한지 판단하는
								지표입니다. 두 수치 모두 낮을수록 유의미합니다. 우라늄과 석탄의 경우 다른 자원들의 시세에 비해 높은 수치의
								p값을 가지고 있었으며, 두 자원의 시세를 모델에서 제거하는 것이 최적의 AIC수치를 도출 가능하여 제거되었습니다.
								실제로도 우라늄의 경우, 해외의 농축 공장을 거쳐 국내 반입되어 발전에 사용되며, 농축 공장의 경우 장기계약을
								체결하여 우라늄 원광을 공급받아 국제 시세에 큰 영향을 받지 않습니다. 또한 석탄과 우라늄 모두 원유와 원유의
								대체자원으로서 사용되는 천연가스에 비해 국내 전체 에너지 자원 수입 비용의 변화에 큰 영향을 미치지 않습니다. 2번
								내용을 이걸 쓰기보다는 서머리 내용에 대한 설명을 쓰자. + 데이터 전처리는 어떻게 했는지에 대한 내용 추가할것
								예측 모델에 사용된 변수는 원유 시세와 천연가스의 시세이며, 명년도 수입 예산 예측을 위해 원유 시세는 p값이
								9.21e-06로 매우 작아서 모델에 통계적으로 매우 유의미한 역할을 합니다. 또한, 모델의 설명력을 보여주는
								지표인 결정계수(Multiple R-squared)값은 0.7961로, 전체 변동성의 약 79.61퍼센트나 설명
								가능합니다. 모델이 종속변수(명년도 수입 비용)를 유의미하게 설명하는지를 보여주는
		...
		<div class="section effect">
			<form action="index" method="get">
				...
				<div class="effect-items">
					...
					<div class="sec3Plots">
						...
						<div class="item" data-animation="fade-left">
							<img src="images/Minjunchart4.png" alt="첫번째 플롯">
							<h3>잔차 vs 적합값 플롯</h3>
							<p>Residual vs Fitted</p>
						</div>

						<div class="item" data-animation="fade-left">
							<img src="images/Minjunchart1.png" alt="두번째 플롯">
							<h3>정규 Q-Q 플롯</h3>
							<p>Normal Q-Q</p>
							<br>
						</div>
						...
						<div class="item" data-animation="fade-left">
							<img src="images/Minjunchart2.png" alt="세번째 플롯">
							<h3>스케일-위치 플롯</h3>
						...
						<div class="item" data-animation="fade-left">
							<img src="images/Minjunchart3.png" alt="네번째 플롯">
							<h3>잔차 vs 영향력 플롯</h3>
				...
				<p style="text-align: center;">왼쪽에서 첫번째 플롯이 ‘잔차 vs 적합값
					플롯(Residual vs fitted)’이며, 기울기가 0이 되는것이 이상적입니다. 현재 기울기가 0으로, 이상적인
					형태를 보이고 있습니다. 두 번째 플롯인 ‘정규 Q-Q 플롯(Normal Q-Q plot)’의 경우 잔차가 정규 분포를
					따르는지 확인하기 위한 그래프로, 대각선 직선(주로 45도)에 가깝게 점들이 분포합니다. 현재 이상적인 플롯의 형태를
					보여주고 있습니다. 세 번째 플롯인 ‘스케일-위치 플롯(Scale-Location plot)’의 경우 기울기가 0인
					직선이 이상적이며, 이상치를 확인 가능합니다. 점들이 x축과 평행하여 고르게 분포하여, 수평선의 형태로 보이는 것이
					좋습니다. 네 번째 플롯인 ‘잔차 vs 영향력 플롯(Residual vs Leverage plot)’의 경우 이상치가
					있는지에 대한 정보를 제공합니다. 잔차가 매우 크거나 작아서 이상치로 고려되는 점이 없이 무작위 패턴으로 점들이 분포되면
					이상적입니다.residual vs fitted, normal qq, scale location, residual vs
